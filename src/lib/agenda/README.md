...
3. La agenda usa datos en **localStorage** por defecto (seed la primera vez). Para resetear datos, borra las claves `agenda_appointments`, `agenda_patients`, `agenda_doctors`, `agenda_chairs` en localStorage.
